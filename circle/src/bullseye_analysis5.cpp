...
int main(int argc, char** argv)
{
  ...
  rois.at<int>(8,0)  = 638;
  rois.at<int>(9,0)  = 662;
  rois.at<int>(10,0) = 668;
  rois.at<int>(11,0) = 678;
  rois.at<int>(12,0) = 690;
  rois.at<int>(13,0) = 694;
  rois.at<int>(14,0) = 688;
  rois.at<int>(15,0) = 696;
  rois.at<int>(16,0) = 704;
  rois.at<int>(17,0) = 704;
  rois.at<int>(18,0) = 706;
  rois.at<int>(19,0) = 724;

  rois.at<int>(0,1)  = 1184;
  rois.at<int>(1,1)  = 1080;
  rois.at<int>(2,1)  = 1040;
  rois.at<int>(3,1)  = 1050;
  rois.at<int>(4,1)  = 1030;
  rois.at<int>(5,1)  = 1020;
  rois.at<int>(6,1)  = 964;
  rois.at<int>(7,1)  = 950;
  rois.at<int>(8,1)  = 942;
  rois.at<int>(9,1)  = 940;
  rois.at<int>(10,1) = 930;
  rois.at<int>(11,1) = 920;
  rois.at<int>(12,1) = 910;
  rois.at<int>(13,1) = 905;
  rois.at<int>(14,1) = 898;
  rois.at<int>(15,1) = 890;
  rois.at<int>(16,1) = 885;
  rois.at<int>(17,1) = 880;
  rois.at<int>(18,1) = 875;
  rois.at<int>(19,1) = 885;
  ...
  rois.at<int>(8,2)  = 380;
  rois.at<int>(9,2)  = 394;
  rois.at<int>(10,2) = 400;
  rois.at<int>(11,2) = 420;
  rois.at<int>(12,2) = 430;
  rois.at<int>(13,2) = 440;
  rois.at<int>(14,2) = 450;
  rois.at<int>(15,2) = 455;
  rois.at<int>(16,2) = 466;
  rois.at<int>(17,2) = 470;
  rois.at<int>(18,2) = 478;
  rois.at<int>(19,2) = 480;
  ...
  rois.at<int>(8,3)  = 622;
  rois.at<int>(9,3)  = 622;
  rois.at<int>(10,3) = 620;
  rois.at<int>(11,3) = 620;
  rois.at<int>(12,3) = 624;
  rois.at<int>(13,3) = 620;
  rois.at<int>(14,3) = 622;
  rois.at<int>(15,3) = 620;
  rois.at<int>(16,3) = 620;
  rois.at<int>(17,3) = 620;
  rois.at<int>(18,3) = 622;
  rois.at<int>(19,3) = 616;
  ...
  int q=0;
  for(int i=30;i<130;i+=5){// for each directory
    for(int j=0;j<51;j++){ // for each image in directory
      char image_name[15];
      sprintf(image_name,"./d%d/v%02d.tiff",i,j);
      //      printf("image_name = %s\n",image_name);
	...
	if(c=='q') pause=false;
      ...
      Point3d P; // used for both half of next if
